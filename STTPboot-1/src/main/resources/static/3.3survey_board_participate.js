...
document.addEventListener('DOMContentLoaded', function() {
	...
	var inputs = document.querySelectorAll('.question-div input');
	var textareas = document.querySelectorAll('.question-div textarea');
	...
	if (textareas && textareas.length) {
		textareas.forEach(function(textarea) {
			textarea.addEventListener('keyup', updateProgress);
		});
	}

	function updateProgress() {
		var checkedCount = document.querySelectorAll('.question-div input:checked').length;
		...
		document.querySelector("#controller-count-div div").textContent = checkedCount;
