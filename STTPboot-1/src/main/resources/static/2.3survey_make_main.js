...
function checkAnswerCount(type, newAnswerBtn) {
  ...
  console.log("answerCounts:", answerCounts[type]);
  console.log("maxAnswerCounts:", maxAnswerCounts[type]);
...
for (let i = 0; i < newSurveyBtns.length; i++) {
  ...
  newSurveyBtns[i].addEventListener("click", function (e) {
    ...
    // bottomDiv 생성
    let bottomDiv = createBottomDiv(totalDiv);
...
// let count = 0;
// bottomDiv 생성 함수
function createBottomDiv(totalDiv) {
  // count++;
